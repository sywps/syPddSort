...
exports.PvpHumanReplay = exports.PVP_MAX_ELAPSED_MS = exports.HUMAN_REPLAY_VERIFICATION = exports.HUMAN_REPLAY_PROTOCOL = void 0;
...
exports.PVP_MAX_ELAPSED_MS = 24 * 60 * 60 * 1000;
class PvpHumanReplay {
    constructor(level, maxElapsedMs = 600000, allowAssists = false, enforceTimeLimit = true) {
        this.level = level;
    ...
    apply(event) {
        ...
        if (kind >= 5) {
            ...
            if (this.enforceTimeLimit && !this.allowAssists && this.firstTap >= 0
                && time > this.firstTap + this.level.timeLimit * 1000 + 1000)
    ...
    finish(terminalType, time) {
        ...
        if (this.enforceTimeLimit && terminalType === 'PASS' && this.firstTap >= 0
            && this.completedAt > this.firstTap + this.level.timeLimit * 1000 + 1000)
...
function replayHumanEvents(level, envelope) {
    ...
    const replay = new PvpHumanReplay(level, exports.PVP_MAX_ELAPSED_MS, false, false);
