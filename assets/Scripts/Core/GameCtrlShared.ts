...
const LOCAL_BOOTSTRAP_ALWAYS_TEXTURE_NAMES = new Set<string>(['设置', ...MAINLINE_SLOT_TEXTURE_NAMES, ...MAINLINE_GAMEPLAY_HUD_TEXTURE_NAMES, ...MAINLINE_SETTLEMENT_PROGRESS_TEXTURE_NAMES]);
const LOCAL_BOOTSTRAP_TEXTURE_NAMES = new Set<string>([...MAINLINE_SLOT_TEXTURE_NAMES, ...MAINLINE_GAMEPLAY_HUD_TEXTURE_NAMES, ...MAINLINE_SETTLEMENT_PROGRESS_TEXTURE_NAMES]);
...
const CLOUD_STATE_RESTORE_EMPTY_INSTALL_TIMEOUT_MS = 3000;
