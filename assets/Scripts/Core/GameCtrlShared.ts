...
import {
    ...
    REMOTE_BOOTSTRAP_PRELOAD_TEXTURE_PATHS,
    REMOTE_PRELOAD_TEXTURE_PATHS,
    REMOTE_TEXTURE_SEARCH_DIRS,
...
const MAINLINE_SLOT_ROW_SPACING = 52;
const MAINLINE_SLOT_PANEL_EXTRA_HEIGHT = 14;
const MAINLINE_SLOT_CENTER_SPACING = 50;
const MAINLINE_SLOT_MARKER_WIDTH = 34;
const MAINLINE_SLOT_MARKER_HEIGHT = 36;
...
const LOCAL_BOOTSTRAP_TEXTURE_DIR = 'UI';
const LOCAL_BOOTSTRAP_REMOTE_WARM_DELAY = 1.0;
const PINDD_BEAN_VARIANTS: Array<1 | 2 | 4> = [1, 2, 4];
const LOCAL_BOOTSTRAP_ALWAYS_TEXTURE_NAMES = new Set<string>(HOME_MENU_TEXTURE_NAMES);
const LOCAL_BOOTSTRAP_TEXTURE_NAMES = new Set<string>(MAINLINE_SLOT_TEXTURE_NAMES);
...
const CLOUD_STATE_RESTORE_TIMEOUT_MS = 800;
const CLOUD_STATE_RESTORE_EMPTY_INSTALL_TIMEOUT_MS = 1000;
...
const REMOTE_EFFECTS_IDLE_WARMUP = false;

const SKILL_UNLOCK_WAND = 5;
const SKILL_UNLOCK_BROOM = 9;
const SKILL_UNLOCK_MAGNET = 22;
...
type UserStateRestoreStatus = 'skipped' | 'restored' | 'empty' | 'timeout' | 'failed';
...
export {
    ...
    GOLD_SHOP_TEXTURE_NAMES, HOME_MENU_TEXTURE_NAMES, LEADERBOARD_RELEASE_TEXTURE_NAMES, LEADERBOARD_TEXTURE_NAMES, POPUP_UI_TEXTURE_NAMES, RECOVER_VIGOR_RELEASE_TEXTURE_NAMES, RECOVER_VIGOR_TEXTURE_NAMES, REMOTE_BOOTSTRAP_PRELOAD_TEXTURE_PATHS, REMOTE_PRELOAD_TEXTURE_PATHS,
