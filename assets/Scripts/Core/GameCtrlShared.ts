...
import {
    ...
    PHYSICAL_FIRST_PLAY_BUNDLE_NAME,
...
const LOCAL_BOOTSTRAP_ALWAYS_TEXTURE_NAMES = new Set<string>(['设置', ...MAINLINE_SLOT_TEXTURE_NAMES, ...MAINLINE_GAMEPLAY_HUD_TEXTURE_NAMES, ...MAINLINE_TUTORIAL_TEXTURE_NAMES, ...MAINLINE_SETTLEMENT_PROGRESS_TEXTURE_NAMES]);
const LOCAL_BOOTSTRAP_TEXTURE_NAMES = new Set<string>([...MAINLINE_SLOT_TEXTURE_NAMES, ...MAINLINE_GAMEPLAY_HUD_TEXTURE_NAMES, ...MAINLINE_TUTORIAL_TEXTURE_NAMES, ...MAINLINE_SETTLEMENT_PROGRESS_TEXTURE_NAMES]);
...
const FIRST_LEVEL_ROUTE_EXPERIMENT_ID = 'first_level_route';
const FIRST_LEVEL_ROUTE_WX_TIMEOUT_MS = 1200;
...
type FirstLevelRouteBucket = 'bucket_a' | 'bucket_b';
type FirstLevelRouteVariant = FirstLevelRouteBucket;
type FirstLevelRouteResolution = {
    bucket: FirstLevelRouteBucket;
    source: 'url' | 'wechat_experiment' | 'default';
};
type InventoryPropKind = 'expand' | 'wand' | 'brush' | 'magnet';
...
export {
    ...
    LOCAL_BOOTSTRAP_LEVEL_IDS, LOCAL_BOOTSTRAP_LEVEL_PREFIX, LOGICAL_COCOS_CORE_BUNDLE_NAME, LOGICAL_FIRST_PLAY_BUNDLE_NAME, LOGICAL_HOME_BUNDLE_NAME, LOGICAL_GAMEPLAY_BUNDLE_NAME, LOGICAL_REMOTE_LEVEL_DATA_BUNDLE_NAME, PHYSICAL_COCOS_CORE_BUNDLE_NAME, PHYSICAL_FIRST_PLAY_BUNDLE_NAME, PHYSICAL_HOME_BUNDLE_NAME, PHYSICAL_GAMEPLAY_BUNDLE_NAME, PHYSICAL_REMOTE_LEVEL_DATA_BUNDLE_NAME, LOCAL_BOOTSTRAP_BUNDLE_NAME, HOME_ASSETS_BUNDLE_NAME, GAME_ASSETS_BUNDLE_NAME, LEVEL_DATA_BUNDLE_NAME, LOCAL_BOOTSTRAP_BEAN_DIR, LOCAL_BOOTSTRAP_BEAN_ATLAS_DATA_PATH, LOCAL_BOOTSTRAP_BEAN_ATLAS_TEXTURE_PATH, LOCAL_BOOTSTRAP_LEVEL_DIR, LOCAL_BOOTSTRAP_TEXTURE_DIR,
