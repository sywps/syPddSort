...
export function collectDebugPerfRuntimeSnapshot(runtime: any): PlainRecord {
    ...
    return {
        ...
        effectFrameCacheSize: getMapLikeSize(runtime._effectFrameCache),
        ...
        effectsAtlasReady: !!runtime._effectsAtlasReady,
        activeFrameFxCount: Math.max(0, Number(runtime._activeFrameFxCount) || 0),
        ...
        frameFxPoolSize: getPoolSize(runtime, runtime._frameFxPool),
