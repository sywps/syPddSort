...
export const LOCAL_ATLAS_MEMBER_ROUTES: Readonly<Record<string, string>> = Object.freeze({
    'bootstrap:exit_1': 'GameUI/Atlases/Conveyor/exit_1',
    'bootstrap:exit_2': 'GameUI/Atlases/Conveyor/exit_2',
    'bootstrap:exit_1_2': 'GameUI/Atlases/Conveyor/exit_1_2',
    'bootstrap:exit_1_3': 'GameUI/Atlases/Conveyor/exit_1_3',
    'bootstrap:exit_1_4': 'GameUI/Atlases/Conveyor/exit_1_4',
    'bootstrap:conveyor_7a': 'GameUI/Atlases/Conveyor/conveyor_7a',
    'bootstrap:conveyor_7b': 'GameUI/Atlases/Conveyor/conveyor_7b',
    'bootstrap:conveyor_v2_track': 'GameUI/Atlases/Conveyor/track',
    'bootstrap:conveyor_v2_expand': 'GameUI/Atlases/Conveyor/expand',
    'bootstrap:conveyor_v2_arrow': 'GameUI/Atlases/Conveyor/arrow',
    'bootstrap:conveyor_v2_capacity_gradient': 'GameUI/Atlases/Conveyor/capacity-gradient',
