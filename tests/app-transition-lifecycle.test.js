...
async function verifyGameplayEntries(fixture) {
    ...
    const dependencies = {
        ...
        './BrowserLevelPreview': { getBrowserLevelPreview: () => ({ active: false }) },
        '../GameplayChurnTelemetry': { beginChurnTransition() {}, requestChurnLevel() {}, trackGameplayChurn() {} },
        './GameplayChurnTelemetry': { beginChurnAttempt() {}, finishChurnReady() {}, trackGameplayChurn() {} },
        ...
        '../RuntimeLog': {}, '../PixelPosterPreviewRenderer': {}, '../CompletedPatternPreview': { renderCompletedPatternPreview() {} }, '../LevelExperimentService': {},
        '../RuntimeAssetRelease': { ensureRuntimeAssetReleaseId: () => 'test' }, '../FirstLevelContent': { getLocalLevelContentPath: () => '' },
