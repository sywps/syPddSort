...
assert.equal(rules.shouldShowRedWarning(3), true, 'two empty slots with no returnable top must warn');
rules.carriers[19][0] = 2;
assert.equal(rules.shouldShowRedWarning(3), false, 'a returnable top must clear the warning');
